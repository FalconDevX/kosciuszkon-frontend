          ...
          >
            ...
            <div className="mt-6 space-y-2">
              ...
              <input
                ...
                readOnly
                disabled
                placeholder={s.accountEmailInputPlaceholder}
                className="mt-1 w-full max-w-md rounded-xl border border-zinc-800 bg-zinc-950/80 px-4 py-2.5 text-sm text-zinc-400 placeholder:text-zinc-600 disabled:cursor-not-allowed"
              />
            </div>
          </motion.div>
            ...
            <div className="mt-6 space-y-8">
              <div className="space-y-2">
                ...
                <input
                  ...
                  readOnly
                  disabled
                  placeholder={s.languageSettingPlaceholder}
                  className="mt-1 w-full max-w-md rounded-xl border border-zinc-800 bg-zinc-950/80 px-4 py-2.5 text-sm text-zinc-400 placeholder:text-zinc-600 disabled:cursor-not-allowed"
                />
              </div>
              <div className="space-y-2">
                ...
                <input
                  readOnly
                  disabled
                  placeholder={s.notificationsPlaceholder}
                  className="mt-1 w-full max-w-md rounded-xl border border-zinc-800 bg-zinc-950/80 px-4 py-2.5 text-sm text-zinc-400 placeholder:text-zinc-600 disabled:cursor-not-allowed"
                  aria-label={s.notificationsLabel}
                />
              </div>
            </div>
          </motion.div>
